...
2. Get an IP adress for the BBB from the DHCP server. Refer to [DHCP problems](#62-dhcp-problems) if you are having problems with this.
3. Get the BBB bootsystem kernel via TFTP.
   1. 
