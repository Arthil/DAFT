...
5. Flash the target image fetched from the PC Host via FNS to the DUTs memory storage. The DUT doesn't connect directly to the PC Host but instead through the BBB, which forwards the data to the DUT.
